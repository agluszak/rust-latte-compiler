...
entry:
  ...
  %fd = load ptr, ptr @stdin, align 8
  %chars_read = call i32 @getline(ptr noundef %buf, ptr noundef %size, ptr noundef %fd)
  %len = sub i32 %chars_read, 1
  ...
  store i32 %len, ptr %len_ptr, align 4
  store i32 %len, ptr %len_ptr3, align 4
  ret ptr %string
}
